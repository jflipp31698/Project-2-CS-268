    ...
    render() {
        return (
            <div className="header">
                    ...
                    <div className="about">
                        <h2 className = "homeColor">Your Journey To College Success Starts Here</h2>
                        ...
                        <h2 className = "homeColor">Get Social</h2>
                        ...
                        <h2 className = "homeColor" >Orientation</h2>
             ...
             <a href="https://www.uwec.edu/"> UWEC OFFICIAL HOME PAGE</a>  
             <br></br>     
            </div>
        )
    }

        ...
        <div className = "page">
          <div className = 'topHeader'>
                    <div className="header">
                      <h2>
                        University of Wisconsin Eau Claire Biology Department 
                      </h2>
                    </div>
              </div>
          <Container>
          ...
          <Col sm={1}>
            ...
            <div className = 'mainContent'>
              ...
              <div className="header">
                  <h2>
                    About Eau Claire Biology Department
                  </h2>
              </div>
            <br></br>
            <div className="header">
            ...
            <Card>
              <Card.Body>
                <Card.Title>Biochemistry and Molecular Biology:</Card.Title>
            ...
            <Card>
              <Card.Body>
                <Card.Title>Biology – Ecology and Environmental Biology Emphasis:</Card.Title>
                <Card.Subtitle className="mb-2 text-muted">Major</Card.Subtitle>
                <Card.Text>
            ...
            <Card>
              <Card.Body>
                <Card.Title>Biology - Microbiology Emphasis:</Card.Title>
                <Card.Subtitle className="mb-2 text-muted">Major</Card.Subtitle>
                <Card.Text>
            ...
            <Card>
              <Card.Body>
                <Card.Title>Environmental Science: </Card.Title>
            ...
            <Card>
              <Card.Body>
                <Card.Title>Marine Science:  </Card.Title>
                <Card.Subtitle className="mb-2 text-muted">Minor</Card.Subtitle>
                <Card.Text>
            ...
            <Card>
              <Card.Body>
                <Card.Title>Teaching - Science, Biology Emphasis:  </Card.Title>
                <Card.Subtitle className="mb-2 text-muted">Major</Card.Subtitle>
                <Card.Text>
            ...
            <Card>
            <Card.Body>
                <Card.Title>Pre-Optometry: </Card.Title>
                <Card.Subtitle className="mb-2 text-muted">--</Card.Subtitle>
                <Card.Text>
            ...
            <Card>
            <Card.Body>
                <Card.Title>Pre-Pharmacy: </Card.Title>
                <Card.Subtitle className="mb-2 text-muted">--</Card.Subtitle>
                <Card.Text>
            ...
            <Card>
            <Card.Body>
                <Card.Title>Pre-Physician Assistant: </Card.Title>
                <Card.Subtitle className="mb-2 text-muted">--</Card.Subtitle>
                <Card.Text>
            ...
            <Card>
            <Card.Body>
                <Card.Title>Pre-Veterinary Madicine:  </Card.Title>
                <Card.Subtitle className="mb-2 text-muted">--</Card.Subtitle>
                <Card.Text>
